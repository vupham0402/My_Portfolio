...
<body>
<div style="text-align: center; margin-top: 200px;"><img src="https://vendorslogos.s3.amazonaws.com/eyePro_logo_Main.png" alt="eyePro_logo_Main.png"></div>
<p style="text-align: center; font-size: 40px;">Sign in with Wild Apricot</p>
<div class="login">
    <form method="post">
