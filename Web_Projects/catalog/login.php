...
<body>
<div style="text-align: center; margin-top: 100px;"><img src="https://vendorslogos.s3.amazonaws.com/EyePro_newlogo.png" width="40%" alt="eyePro_logo_Main.png"></div>
<p style="text-align: center; font-size: 40px; margin-top: -10px;">Sign in with Wild Apricot</p>
<div class="login">
    <form method="post">
        <input name="email" type="email" placeholder="Email" required/>
        <input type="password" name="password" placeholder="Password" required>
        <input type="submit" class="login" value="Sign in" style="background: #05a;">
    </form>
</div>
