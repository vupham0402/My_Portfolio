...
<main>
    ...
    <p id="text" style="font-size: 18px; visibility: hidden; text-align: center;">Local pricing applies with a $25 rebate for each eligible iStent purchased.<br>
           Purchases based on discounted/annual pricing agreements with Glaukos are not eligible.
    </p>
    <button style="margin-top: -17px; margin-left: 1535px;" type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal2">Vendor Tiered Pricing Reference</button>
                    ...
                    <div class="calculator">
                        ...
                        <div class="group">
                            ...
                            <select id='tier' onchange="Unit();">
                                ...
                                <option value="tier2" id='tier2'>Tier 2</option>
                                <option value="tier3" id='tier3'>Tier 3</option>
                        ...
                        <div class="group">
                            ...
                            <input type="number" disabled id="savings" class="textBox" style="font-weight: 600; width: 77%;">
                        </div>
                    </div>        
                </form>
            </div>
